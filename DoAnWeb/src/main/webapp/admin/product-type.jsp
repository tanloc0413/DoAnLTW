                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="product-status-wrap">
                        ...
                        <table>
                            ...
                            <c:forEach var="directorys" items="${requestScope.categorys}">
                                <c:set var="coler" value="ys-setting"/>
                                <c:if test="${directorys.status != 'Ẩn'}">
                                    <c:set var="coler" value="ps-setting"/>
                                </c:if>
                                <tr>
                                    <td>${directorys.id}</td>
                                    <td>${directorys.name}</td>
                                    <td>
                                        <button class="${coler}">${directorys.status}</button>
                                    </td>
                                    <td>0</td>

                                    <td>
                                        <button data-toggle="tooltip" title="Edit" class="pd-setting-ed" ><a href="addcategory.jsp?id=${directorys.id}"><i class="fa fa-pencil-square-o" aria-hidden="true" style="float: left"></i></a></button>
                                        <form action="./RemoveCategory" method="post" style="float: right">
                                            <input name="ma" value="${directorys.id}" style="display: none">
